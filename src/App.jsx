...
function App() {
  ...
  return (
    <Router>
      <ScrollToTop />
      <div className="font-sans antialiased bg-brand-50 relative overflow-x-hidden w-full flex flex-col min-h-screen">
        ...
        <div className="flex-1">
          <Routes>
            ...
            <Route path="/contact" element={<Contact openBooking={() => setIsBookingOpen(true)} />} />
