    ...
    <footer className="bg-gradient-to-b from-slate-900 to-brand-900 text-white pt-20 pb-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16 border-b border-white/10 pb-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="Dr. Suchithra's Clinic Logo" className="w-20 h-20 object-contain bg-white rounded-full p-2 border-2 border-brand-200 mix-blend-screen contrast-125 saturate-150 shadow-lg" />
              <span className="font-serif font-semibold text-2xl">
                Dr. Suchithra's
              </span>
            </div>
            <p className="font-serif text-xl text-brand-200 italic mb-6">
          ...
          {/* Connect & Locate Col */}
          <div>
            <h4 className="text-white font-semibold text-lg mb-6">Locate Us</h4>
            ...
            <h4 className="text-white font-semibold text-lg mb-4 mt-8">Hours</h4>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://instagram.com/dr_suchithrac" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-500 transition-colors">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-slate-400 text-sm">
          <p>© {new Date().getFullYear()} Dr. Suchithra's Skin & Hair Care. All rights reserved.</p>
